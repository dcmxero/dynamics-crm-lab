...
/// </summary>
/// <remarks>
/// Register on Create and Update of dcl_workorder, synchronous.
///
...
public sealed class WorkOrderPricingPlugin() : PluginBase(nameof(WorkOrderPricingPlugin))
{
    ...
    protected override void Execute(PluginContext context)
    {
        ...
        context.Service.Update(new Entity(WorkOrderColumns.EntityName, target.Id)
        {
            [WorkOrderColumns.TotalPrice] = new XrmMoney(total.Amount)
        });
    }
